...
<div>
  ...
  <div class="chooseTablePagination">
    <el-pagination
     :current-page="startQuery.page"
     :page-sizes="[5,10]"
     :page-size="startQuery.pageSize"
     :total="this.startLessonData.length"
      background
...
<script>
  export default {
    ...
    methods: {
      ...
      //选课的确认按钮
      sureChoose(){
        this.dialogStartLessonVisible = false
      }, 
      //选择课程的点击按钮
      startRow(row,index){
        this.dialogStartLessonVisible = true
      },
      //显示选课所有课程的分页
